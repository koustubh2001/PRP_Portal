...
const PlacementofficerLogin = () => {
  ...
  const closeModal = () => {
    ...
    if (modal.success) {
      navigate("/PRP_Portal/PlacementOfficerDashboard");
    }
  };
        ...
        <div>
          <div className="Common-Login-header">
            ...
            <div className="Common-Login-header-actions">
              ...
              <button className="Common-Login-help-center-button">
                Help Center
              </button>
            </div>
          </div>
          ...
          <div className="UserLogin-Form-Center-Wrapper">
            <form onSubmit={handleSubmit} className="UserLogin-Form-Box">
              ...
              <div className="UserLogin-Links">
                <Link
                  to={"/PRP_Portal/Login/Forgotpassword"}
                  className="UserLogin-ForgetPassword-Link"
                >
                  Forget Password?
                </Link>
                <Link className="UserLogin-Request-Access-Link">
                  Request Access
                </Link>
              </div>
            </form>
